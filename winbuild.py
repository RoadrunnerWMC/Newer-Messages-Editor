...
setup(
    name = 'Newer Messages Editor',
    version = Version,
    description = 'Newer Messages Editor',
    options={
        'build_exe': {
            'excludes': excludes,
...
if os.path.isdir(dir_ + '/data'): shutil.rmtree(dir_ + '/data') 
shutil.copytree('data', dir_ + '/data') 
...
print('>> Newer Messages Editor has been frozen to %s !' % dir_)
